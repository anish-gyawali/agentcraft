...
import { sendMessage as sendMessageAPI, indexCodebase as indexCodebaseAPI, indexPDF as indexPDFAPI } from "../api/client"
...
const indexPDF = async () => {
  ...
  try {
    await indexPDFAPI("backend/data/cleancode.pdf")
    setStatus("PDF indexed successfully")
  } catch {
    setStatus("PDF indexing failed")
  } finally {
    setTimeout(() => setStatus(""), 3000)
  }
}
  return {
    ...
    sendMessage, indexCodebase, indexPDF, newChat, selectChat, bottomRef
  }
}